...
{
	FG::EntityManager::Instance()->CreateEntity<LightBullet>(startPos + FG::Vector2D(0, 1.0f), dir , BURST_DARK_SPEED, collidesWith);
	FG::EntityManager::Instance()->CreateEntity<LightBullet>(startPos + FG::Vector2D(0, 0.6f), dir , BURST_DARK_SPEED, collidesWith);
	FG::EntityManager::Instance()->CreateEntity<LightBullet>(startPos, dir, BURST_DARK_SPEED, collidesWith);
	FG::EntityManager::Instance()->CreateEntity<LightBullet>(startPos + FG::Vector2D(0, -0.6f), dir, BURST_DARK_SPEED, collidesWith);
	FG::EntityManager::Instance()->CreateEntity<LightBullet>(startPos + FG::Vector2D(0, -1.0f), dir, BURST_DARK_SPEED, collidesWith);
}
